...
public class P_P extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_P content = new P_P ();
        
        JFrame window = new JFrame ("Perimeter - Pentagon");
    ...
    public P_P ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Pentagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("P/P_Pentagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
			...
			if (a>0)
			{
				double perimeter = Math.round(5*a);
				calc.setText("<html>Here are the calculations: <br> <br> P = 5*a <br> <br> P = 5 * " + a + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_P.class.getResource(path);
    	if (imgURL != null)
    	{
