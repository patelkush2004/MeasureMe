...
public class SA_CU extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        SA_CU content = new SA_CU ();
        
        JFrame window = new JFrame ("Surface Area - Cube");
    ...
    public SA_CU ()
    {
        ...
        JLabel Instruction = new JLabel ("Surface Area - Cube");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("SA/SA_Cube.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0)
    		{
    			...
    			calc.setText("<html>Here are the calculations: <br> <br> SA = 6 * a * a <br> SA = 6 *" + a + "*" + a + " <br> SA = " + SA +" </html>");
    ...
    {
    	java.net.URL imgURL = SA_CU.class.getResource(path);
    	if (imgURL != null)
    	{
