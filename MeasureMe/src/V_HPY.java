...
public class V_HPY extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        V_HPY content = new V_HPY ();
        
        JFrame window = new JFrame ("Volume - Hexagonal Pyramid");
    ...
    public V_HPY ()
    {
        ...
        JLabel Instruction = new JLabel ("Volume - Hexagonal Pyramid");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("V/V_HexagonalPyramid.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0 && h>0)
    		{
    			double V = (Math.sqrt(3)/2)*a*a*h;
    			double answer = Math.round(V);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> V = ((3^1/2)/2)*a*a*h <br> V = ((3^1/2)/2)*"+a+"*"+a+"*"+h+" <br> V = " + V +" </html>");
    ...
    {
    	java.net.URL imgURL = V_HPY.class.getResource(path);
    	if (imgURL != null)
    	{
