...
public class SA_Co extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        SA_Co content = new SA_Co ();
        
        JFrame window = new JFrame ("Surface Area - Cone");
    ...
    public SA_Co ()
    {
        ...
        JLabel Instruction = new JLabel ("Surface Area - Cone");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("SA/SA_Cone.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0 && h>0)
    		{
    			double SA = Math.PI * a * (a + Math.sqrt((h*h)+(a*a)));
    			double answer = Math.round(SA);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> SA = PI * r * (r + (h^2 + r^2)^1/2 <br> SA = PI *" + a + "*(" + a + "+ (" + h*h + "+" + a*a + ")^1/2 <br> SA = " + SA +" </html>");
    ...
    {
    	java.net.URL imgURL = SA_Co.class.getResource(path);
    	if (imgURL != null)
    	{
