...
public class A_N extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        A_N content = new A_N ();
        
        JFrame window = new JFrame ("Area - Nonagon");
    ...
    public A_N ()
    {
        ...
        JLabel Instruction = new JLabel ("Area - Nonagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("A/A_Nonagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0)
    		{
    			...
    			double answer = Math.round((2.25*a*a) * (2.747477419));
    			
    			calc.setText("<html> Here are the calculations: <br> <br> A = (2.25*a^2) * ((cos(180/9)/(sin(180/9)"
    					+ "<br> A = 2.25 *" + a +"*"+ a + "((cos(180/9)/(sin(180/9))  "
    							+ "<br> A =" + answer + "</html>");
    ...
    {
    	java.net.URL imgURL = A_N.class.getResource(path);
    	if (imgURL != null)
    	{
