...
public class P_Hept extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_Hept content = new P_Hept ();
        
        JFrame window = new JFrame ("Perimeter - Heptagon");
    ...
    public P_Hept ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Heptagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("P/P_Heptagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
			...
			if (a>0)
			{
				double perimeter = Math.round(7*a);
				calc.setText("<html>Here are the calculations: <br> <br> P = 7*a <br> <br> P = 7 * " + a + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_Hept.class.getResource(path);
    	if (imgURL != null)
    	{
