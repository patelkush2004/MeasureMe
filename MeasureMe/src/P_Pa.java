...
public class P_Pa extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_Pa content = new P_Pa ();
        
        JFrame window = new JFrame ("Perimeter - Parallelogram");
    ...
    public P_Pa ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Parallelogram");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("P/P_Parallelogram.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
			...
			if (b>0 && h>0)
			{
				double perimeter = Math.round(2*b + 2*h);
				calc.setText("<html>Here are the calculations: <br> <br> P = 2*b + 2*a <br> <br> P = 2 * " + b + "+ 2 *" + h + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_Pa.class.getResource(path);
    	if (imgURL != null)
    	{
