...
public class V_PPY extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        V_PPY content = new V_PPY ();
        
        JFrame window = new JFrame ("Volume - Pentagonal Pyramid");
    ...
    public V_PPY ()
    {
        ...
        JLabel Instruction = new JLabel ("Volume - Pentagonal Pyramid");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("V/V_PentagonalPyramid.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0 && h>0)
    		{
    			double V = (0.416)*1.37638192*h*a*a;
    			double answer = Math.round(V);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> V = (5/12)*tan(54)*a*a*h <br> V = (5/12)*tan(54)*"+a+"*"+a+"*"+h+" <br> V = " + V +" </html>");
    ...
    {
    	java.net.URL imgURL = V_PPY.class.getResource(path);
    	if (imgURL != null)
    	{
