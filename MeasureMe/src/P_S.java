...
public class P_S extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_S content = new P_S ();
        
        JFrame window = new JFrame ("Perimeter - Square");
    ...
    public P_S ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Square");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("A/A_Square.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
			...
			if (a>0)
			{
				double perimeter = Math.round(4*a);
				calc.setText("<html>Here are the calculations: <br> <br> P = 4*l <br> <br> P = 4 * " + a + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_S.class.getResource(path);
    	if (imgURL != null)
    	{
