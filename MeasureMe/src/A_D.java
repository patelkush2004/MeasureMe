...
public class A_D extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        A_D content = new A_D ();
        
        JFrame window = new JFrame ("Area - Decagon");
    ...
    public A_D ()
    {
        ...
        JLabel Instruction = new JLabel ("Area - Decagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("A/A_Decagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0)
    		{
    			double area = Math.round((2.5*a*a)*Math.sqrt(5+2*Math.sqrt(5)));
    			
    			calc.setText("<html>Here are the calculations: <br> <br> A = (2.5*a^2) * (5+2*(5)^1/2)^1/2 <br> A = 2.5(" + a + "*" + a + ") * (5+2*(5)^1/2)^1/2 <br> A =" + area + " </html>");
    ...
    {
    	java.net.URL imgURL = A_D.class.getResource(path);
    	if (imgURL != null)
    	{
