...
public class SA_RP extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        SA_RP content = new SA_RP ();
        
        JFrame window = new JFrame ("Surface Area - Rectangular Prism");
    ...
    public SA_RP ()
    {
        ...
        JLabel Instruction = new JLabel ("Surface Area - Rectangular Prism");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("SA/SA_RectangularPrism.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (l>0 && h>0 && w>0)
    		{
    			...
    			calc.setText("<html>Here are the calculations: <br> <br> SA = 2(l*w) + 2(l*h) + 2(w*h) <br> SA = 2("+l+"*"+w+") + 2("+l+"*"+h+") + 2("+w+"*"+h+") <br> SA = " + SA +" </html>");
    ...
    {
    	java.net.URL imgURL = SA_RP.class.getResource(path);
    	if (imgURL != null)
    	{
