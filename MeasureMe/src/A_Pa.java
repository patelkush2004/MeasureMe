...
public class A_Pa extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        A_Pa content = new A_Pa ();
        
        JFrame window = new JFrame ("Area - Parallelogram");
    ...
    public A_Pa ()
    {
        ...
        JLabel Instruction = new JLabel ("Area - Parallelogram");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("A/A_Parallelogram.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (b>0 && h>0)
    		{
    			...
    			calc.setText("<html>Here are the calculations: <br> <br> A = bh <br> A = (" + b + "*" + h + ") <br> A =" + area + " </html>");
    ...
    {
    	java.net.URL imgURL = A_Pa.class.getResource(path);
    	if (imgURL != null)
    	{
