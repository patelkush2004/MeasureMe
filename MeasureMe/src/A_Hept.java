...
public class A_Hept extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        A_Hept content = new A_Hept ();
        
        JFrame window = new JFrame ("Area - Heptagon");
    ...
    public A_Hept ()
    {
        ...
        JLabel Instruction = new JLabel ("Area - Heptagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("A/A_Heptagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0)
    		{
    			...
    			double answer = Math.round((1.75*a*a) * (2.076521397));
    			
    			calc.setText("<html> Here are the calculations: <br> <br> A = (1.75*a^2) * ((cos(180/7)/(sin(180/7)"
    					+ "<br> A = 1.75 *" + a +"*"+ a + "((cos(180/7)/(sin(180/7))  "
    							+ "<br> A =" + answer + "</html>");
    			output.setText("The rounded Area for this Shape is " + answer  + " units squared.");
    		}
    		else 
    		{
    ...
    {
    	java.net.URL imgURL = A_Hept.class.getResource(path);
    	if (imgURL != null)
    	{
