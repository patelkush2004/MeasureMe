...
public class V_Sph extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        V_Sph content = new V_Sph ();
        
        JFrame window = new JFrame ("Volume - Sphere");
    ...
    public V_Sph ()
    {
        ...
        JLabel Instruction = new JLabel ("Volume - Sphere");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("V/V_Sphere.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (r>0)
    		{
    			double V = 1.33333333*Math.PI*r*r*r;
    			double answer = Math.round(V);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> V = (4/3)*PI*r*r**r <br> V = (4/3)*PI*"+r+"*"+r+"*"+r+" <br> V = " + V +" </html>");
    ...
    {
    	java.net.URL imgURL = V_Sph.class.getResource(path);
    	if (imgURL != null)
    	{
