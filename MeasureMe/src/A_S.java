...
public class A_S extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        A_S content = new A_S ();
        
        JFrame window = new JFrame ("Area - Square");
    ...
    public A_S ()
    {
        ...
        JLabel Instruction = new JLabel ("Area - Square");
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0)
    		{
    			double area = Math.round(Math.pow(a, 2));
    			
    			calc.setText("<html>Here are the calculations: <br> <br> A = l^2 <br> A = (" + a + "*" + a + ") <br> A =" + area + " </html>");
    ...
    {
    	java.net.URL imgURL = A_S.class.getResource(path);
    	if (imgURL != null)
    	{
