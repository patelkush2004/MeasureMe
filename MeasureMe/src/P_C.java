...
public class P_C extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_C content = new P_C ();
        
        JFrame window = new JFrame ("Perimeter - Circle");
    ...
    public P_C ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Circle");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("/P/P_Circle.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	...
    	{    		
			...
			if (r>0)
			{
				...
				calc.setText("<html>Here are the calculations: <br> <br> P = 2*PI*r <br> <br> P = 2 * PI * " + r + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_C.class.getResource(path);
    	if (imgURL != null)
    	{
