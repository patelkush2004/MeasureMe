...
public class P_O extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_O content = new P_O ();
        
        JFrame window = new JFrame ("Perimeter - Octagon");
    ...
    public P_O ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Octagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("P/P_Octagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
			...
			if (a>0)
			{
				double perimeter = Math.round(8*a);
				calc.setText("<html>Here are the calculations: <br> <br> P = 8*a <br> <br> P = 8 * " + a + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_O.class.getResource(path);
    	if (imgURL != null)
    	{
