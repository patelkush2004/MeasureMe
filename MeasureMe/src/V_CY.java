...
public class V_CY extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        V_CY content = new V_CY ();
        
        JFrame window = new JFrame ("Volume - Cylinder");
    ...
    public V_CY ()
    {
        ...
        JLabel Instruction = new JLabel ("Volume - Cylinder");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("V/V_Cylinder.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (r>0 && h>0)
    		{
    			...
    			calc.setText("<html>Here are the calculations: <br> <br> V = PI*r*r*h <br> V = PI*"+r+"*"+r+"*"+h+" <br> V = " + V +" </html>");
    ...
    {
    	java.net.URL imgURL = V_CY.class.getResource(path);
    	if (imgURL != null)
    	{
