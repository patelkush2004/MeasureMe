...
public class P_Hex extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_Hex content = new P_Hex ();
        
        JFrame window = new JFrame ("Perimeter - Hexagon");
    ...
    public P_Hex ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Hexagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("P/P_Hexagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
			...
			if (a>0)
			{
				double perimeter = Math.round(6*a);
				calc.setText("<html>Here are the calculations: <br> <br> P = 6*a <br> <br> P = 6 * " + a + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_Hex.class.getResource(path);
    	if (imgURL != null)
    	{
