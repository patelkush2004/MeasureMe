...
public class P_D extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_D content = new P_D ();
        
        JFrame window = new JFrame ("Perimeter - Decagon");
    ...
    public P_D ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Decagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("P/P_Decagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	...
    	{		
    			...
    			if (a>0)
    			{
    				double perimeter = Math.round(10*a);
    				calc.setText("<html>Here are the calculations: <br> <br> P = 10*a <br> <br> P = 10 * " + a + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_D.class.getResource(path);
    	if (imgURL != null)
    	{
