...
public class A_Tr extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        A_Tr content = new A_Tr ();
        
        JFrame window = new JFrame ("Area - Trapezoid");
    ...
    public A_Tr ()
    {
        ...
        JLabel Instruction = new JLabel ("Area - Trapezoid");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("A/A_Trapezoid.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (b>0 && h>0 && a>0)
    		{
    			double area = Math.round(((a+b)/2)*h);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> A = ((a+b)/2)*h <br> A = ((" + a + "+" + b + ")/2) * "+ h + "<br> A =" + area + " </html>");
    ...
    {
    	java.net.URL imgURL = A_Tr.class.getResource(path);
    	if (imgURL != null)
    	{
