...
public class SA_HP extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        SA_HP content = new SA_HP ();
        
        JFrame window = new JFrame ("Surface Area - Hexagonal Prism");
    ...
    public SA_HP ()
    {
        ...
        JLabel Instruction = new JLabel ("Surface Area - Hexagonal Prism");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("SA/SA_HexagonalPrism.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0 && h>0)
    		{
    			double SA = (6*a*h) + (3*Math.sqrt(3)*a*a);
    			double answer = Math.round(SA);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> SA = (6*a*h) + (3*(3)^1/2*(a*a) <br> SA = (6*"+a+"*"+h+") + (3*(3)^1/2*("+a+"*"+a+") <br> SA = " + SA +" </html>");
    ...
    {
    	java.net.URL imgURL = SA_HP.class.getResource(path);
    	if (imgURL != null)
    	{
