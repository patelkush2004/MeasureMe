...
public class V_CU extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        V_CU content = new V_CU ();
        
        JFrame window = new JFrame ("Volume - Cube");
    ...
    public V_CU ()
    {
        ...
        JLabel Instruction = new JLabel ("Volume - Cube");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("V/V_Cube.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0 )
    		{
    			...
    			calc.setText("<html>Here are the calculations: <br> <br> V = a^3 <br> V = "+a+"^3 <br> V = " + V +" </html>");
    ...
    {
    	java.net.URL imgURL = V_CU.class.getResource(path);
    	if (imgURL != null)
    	{
