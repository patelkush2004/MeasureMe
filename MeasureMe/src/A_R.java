...
public class A_R extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        A_R content = new A_R ();
        
        JFrame window = new JFrame ("Area - Rectangle");
    ...
    public A_R ()
    {
        ...
        JLabel Instruction = new JLabel ("Area - Rectangle");
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (l>0 && w>0)
    		{
    			double area = Math.round(l*w);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> A = l*w <br> A = (" + l + "*" + w + ") <br> A =" + area + " </html>");
    ...
    {
    	java.net.URL imgURL = A_R.class.getResource(path);
    	if (imgURL != null)
    	{
