...
public class SA_Sph extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        SA_Sph content = new SA_Sph ();
        
        JFrame window = new JFrame ("Surface Area - Sphere");
    ...
    public SA_Sph ()
    {
        ...
        JLabel Instruction = new JLabel ("Surface Area - Sphere");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("SA/SA_Sphere.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (r>0)
    		{
    			...
    			calc.setText("<html>Here are the calculations: <br> <br> SA = 4*PI*r*r <br> SA = 4*PI*"+r+"*"+r+" <br> SA = " + SA +" </html>");
    ...
    {
    	java.net.URL imgURL = SA_Sph.class.getResource(path);
    	if (imgURL != null)
    	{
