...
public class P_Tr extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_Tr content = new P_Tr ();
        
        JFrame window = new JFrame ("Perimeter - Trapezoid");
    ...
    public P_Tr ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Trapezoid");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("P/P_Trapezoid.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
			...
			if (b>0 && h>0 && a>0 && c>0)
			{
				double perimeter = Math.round(a + b + h + c);
				calc.setText("<html>Here are the calculations: <br> <br> P = a + b + c + d <br> <br> P =" + a + "+" + b + "+" + h + "+" + c + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_Tr.class.getResource(path);
    	if (imgURL != null)
    	{
