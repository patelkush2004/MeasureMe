...
public class SA_PP extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        SA_PP content = new SA_PP ();
        
        JFrame window = new JFrame ("Surface Area - Pentagonal Prism");
    ...
    public SA_PP ()
    {
        ...
        JLabel Instruction = new JLabel ("Surface Area - Pentagonal Prism");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("SA/SA_PentagonalPrism.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0 && h>0)
    		{
    			double SA = (5*a*h) + (0.5*Math.sqrt(5*(5+2*Math.sqrt(5))*a*a));
    			double answer = Math.round(SA);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> SA = (5*a*h) + (0.5*((5*(5+2*(5)^1/2))^1/2)*a*a) <br> SA = (5*"+a+"*"+h+") + (0.5*((5*(5+2*(5)^1/2))^1/2)*"+a+"*"+a+")<br> SA = " + SA +" </html>");
    ...
    {
    	java.net.URL imgURL = SA_PP.class.getResource(path);
    	if (imgURL != null)
    	{
