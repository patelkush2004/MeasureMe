...
public class A_Hex extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        A_Hex content = new A_Hex ();
        
        JFrame window = new JFrame ("Area - Hexagon");
    ...
    public A_Hex ()
    {
        ...
        JLabel Instruction = new JLabel ("Area - Hexagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("A/A_Hexagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0)
    		{
    			double area = Math.round((3*Math.sqrt(3)/(2))*a*a);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> A = (3 * 3^1/2)/(2) *a^2 <br> A = (3 * 3^1/2)/(2) *" + a + "*" + a + "<br> A =" + area + " </html>");
    ...
    {
    	java.net.URL imgURL = A_Hex.class.getResource(path);
    	if (imgURL != null)
    	{
