...
public class P_R extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        P_R content = new P_R ();
        
        JFrame window = new JFrame ("Perimeter - Rectangle");
    ...
    public P_R ()
    {
        ...
        JLabel Instruction = new JLabel ("Perimeter - Rectangle");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("A/A_Rectangle.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	...
    	{
    		double l = Double.parseDouble(l2.getText());
    		double w = Double.parseDouble(w2.getText());
			if (l>0 && w>0)
			{
				double perimeter = Math.round(2*l + 2*w);
				calc.setText("<html>Here are the calculations: <br> <br> P = 2*l + 2*w <br> <br> P = 2 * " + l + "+ 2 *" + w + " <br><br> P =" + perimeter + " </html>");
    ...
    {
    	java.net.URL imgURL = P_R.class.getResource(path);
    	if (imgURL != null)
    	{
