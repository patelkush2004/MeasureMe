...
public class A_P extends JFrame implements ActionListener
{
    public static void main (String args[])
    {
        A_P content = new A_P ();
        
        JFrame window = new JFrame ("Area - Pentagon");
    ...
    public A_P ()
    {
        ...
        JLabel Instruction = new JLabel ("Area - Pentagon");
        ...
        diagram.add(label);
        JLabel image = new JLabel (createImageIcon ("A/A_Pentagon.png"));
        diagram.add(image);
    ...
    public void actionPerformed (ActionEvent e)
    {
    	if (e.getActionCommand().equals("calculate"))
    	{
    		...
    		if (a>0)
    		{
    			double area = Math.round(0.25*Math.sqrt(5*(5+2*Math.sqrt(5)))*a*a);
    			
    			calc.setText("<html>Here are the calculations: <br> <br> A = (0.25*a^2) * (5(5+2*(5)^1/2))^1/2 <br> A = 0.25(" + a + "*" + a + ") * (5(5+2*(5)^1/2))^1/2 <br> A =" + area + " </html>");
    ...
    {
    	java.net.URL imgURL = A_P.class.getResource(path);
    	if (imgURL != null)
    	{
